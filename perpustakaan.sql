...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2024 at 09:26 AM
...
(1, 'nadhif', 'nadhif', 'admin1', '087892312759'),
(2, 'admin', 'admin', 'admin2', '087892312758');
...
INSERT INTO `member` (`NISN`, `nama`, `password`, `jenis_kelamin`, `kelas`, `jurusan`, `no_tlp`) VALUES
(12345, 'yusuf', '$2y$10$wP12R5zg785GZjrlBsuva.tCCh.VQH6X8ZY/8MjW/3pH7YPT5oiQ.', 'Laki laki', 'C', 'Teknik Informatika', '123456789098');
...
INSERT INTO `pengembalian` (`id_pengembalian`, `id_peminjaman`, `id_buku`, `NISN`, `buku_kembali`, `keterlambatan`, `denda`) VALUES
(60, 76, 'bis01', 12345, '2024-06-09', 'TIDAK', 0),
(61, 77, 'inf04', 12345, '2024-06-09', 'YA', 0);
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
